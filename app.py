...
st.markdown("""
    ...
    .header-dark {
        background-color: #1a1d23; padding: 20px; border-radius: 12px;
        border: 1px solid #334155; margin-bottom: 20px;
    }

    .card-vaga {
        background-color: #1a1d23; padding: 18px; border-radius: 10px;
...
st.markdown("""
    <div class="header-dark">
        ...
        <h2 style="color: white; font-size: 1.5rem; margin: 5px 0;">Mercado de Trabalho e Qualificação</h2>
