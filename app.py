...
# 1. CONFIGURAÇÃO DE ESTILO E TEMA
...
st.markdown("""
    ...
    .card-vaga { background-color: #1a1d23; padding: 20px; border-radius: 10px; margin-bottom: 12px; border-top: 1px solid #334155; box-shadow: 0 4px 6px rgba(0,0,0,0.4); }
...
with st.container():
    ...
    with st.expander("Ver Metodologia e Objetivo"):
        st.write("""
            ...
            sobre as reais oportunidades de emprego formal. Cruzamos dados de contratações do **Novo CAGED (Dezembro/2025)** com os 
...
# 4. BASE DE DADOS COMPLETA (Revisada para evitar KeyError)
data_list = [
    # CAJAMAR
    ...
    {"cid": "Cajamar", "ocup": "Conferente", "set": "Logística", "cls": "border-logistica", "sal": "2.600", "niv": "Médio", "esc": "ETEC", "lnk": "https://www.cps.sp.gov.br/", "sld": 310, "bai": "Polvilho"},
    ...
    {"cid": "Caieiras", "ocup": "Auxiliar Administrativo", "set": "Serviços", "cls": "border-servicos", "sal": "2.200", "niv": "Médio", "esc": "ETEC Caieiras", "lnk": "https://www.cps.sp.gov.br/", "sld": 62, "bai": "Centro"},
    # FRANCO DA ROCHA
    ...
    {"cid": "Franco da Rocha", "ocup": "Analista Administrativo", "set": "Serviços", "cls": "border-servicos", "sal": "3.100", "niv": "Superior", "esc": "FATEC Franco", "lnk": "https://www.fatecfrancodarocha.edu.br/", "sld": 22, "bai": "Centro"},
    ...
    {"cid": "Francisco Morato", "ocup": "Vendedor Especializado", "set": "Comércio", "cls": "border-comercio", "sal": "2.200", "niv": "Médio", "esc": "ETEC Morato", "lnk": "http://etecfranciscomorato.com.br/", "sld": 56, "bai": "Centro"},
    ...
    {"cid": "Francisco Morato", "ocup": "Assistente Logístico", "set": "Logística", "cls": "border-logistica", "sal": "2.450", "niv": "Médio", "esc": "ETEC Morato", "lnk": "http://etecfranciscomorato.com.br/", "sld": 42, "bai": "Centro"},
