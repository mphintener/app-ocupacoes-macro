...
with st.container():
    st.markdown("""
        <div class="header-dark">
            <h5 style="margin:0; font-size: 1.1rem;">💡 Entenda este Painel</h5>
            <p style="margin:8px 0 0 0; font-size:0.85rem; color:#94a3b8;">
                ...
                Cruzamos dados do <b>Novo CAGED (Dez/25)</b> com cursos do Centro Paula Souza e <b>Qualifica SP</b>, direcionando você 
                para a preparação correta conforme o nível da vaga.
            </p>
        </div>
    """, unsafe_allow_html=True)
...
st.markdown("""
    <div class="header-dark" style="border-top: 4px solid #3b82f6;">
        <div style="font-size: 0.7rem; color: #64748b; letter-spacing: 1px; font-weight: bold;">📊 INDICADORES DA MACRORREGIÃO</div>
...
# 4. BASE DE DADOS (Correção Definitiva de Conferente, Líder e Auxiliares)
data_list = [
    # CAJAMAR
    ...
    {"cid": "Cajamar", "ocup": "Conferente", "set": "Logística", "cls": "border-logistica", "sal": "2.600", "niv": "Básico/Profissional", "esc": "Qualifica SP / SENAI", "lnk": "https://www.qualificasp.sp.gov.br/", "sld": 310, "bai": "Polvilho"},
    ...
    {"cid": "Cajamar", "ocup": "Op. de Empilhadeira", "set": "Logística", "cls": "border-logistica", "sal": "2.900", "niv": "Básico", "esc": "Qualifica SP / SENAI", "lnk": "https://cajamar.sp.senai.br/", "sld": 85, "bai": "Jordanésia"},
    {"cid": "Cajamar", "ocup": "Líder de Recebimento", "set": "Logística", "cls": "border-logistica", "sal": "3.800", "niv": "Básico/Profissional", "esc": "Qualifica SP / SENAI", "lnk": "https://www.qualificasp.sp.gov.br/", "sld": 45, "bai": "Polvilho"},
...
html_table = """<table class="dark-table"><thead><tr><th>Ocupação</th><th>Nível</th><th>Cidade</th><th>Saldo</th><th>Salário</th></tr></thead><tbody>"""
for i in data_list:
    html_table += f"<tr><td><b>{i['ocup']}</b></td><td>{i['niv']}</td><td>{i['cid']}</td><td style='color:#60a5fa;'>+{i['sld']}</td><td style='color:#10b981; font-weight:bold;'>R$ {i['sal']}</td></tr>"
